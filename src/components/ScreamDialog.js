...
class ScreamDialog extends Component {
  ...
  render() {
    ...
    const {
      ...
      user: {authenticated, credentials: {imageUrl}},
      UI: { loading }
    } = this.props;
    // console.log('in scream disslog',userImage)
    // console.log('in scream dislog',imageUrl)

    let userImg=userImage
// console.log('in scream dislog',screamId)
    ...
    return (
      <Fragment>
        <MyButton
          ...
          // styleProp={{    position: 'absolute',left: '90%'}}
        >
